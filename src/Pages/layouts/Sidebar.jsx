...
export default function Sidebar({isSidebarOpen,setIsSidebarOpen}) {
  ...
  return (
   ...
   <div className="wrapper">
         <aside className={`${isSidebarOpen ? 'expand d-none d-md-block' : 'd-none d-md-block'} 'd-none d-md-block `} id="sidebar">
           ...
           <NavLink to={'/'}>
            ...
            <ul class="sidebar-nav">
                ...
                <p  style={{borderTop:'1px solid white'}} className={`${isSidebarOpen ? '' : 'd-none'} pt-4 ps-4 text-uppercase text-lg ms-2 font-weight-bolder text-white `} >
                User Management
                 </p>
            ...
            <div class="sidebar-footer  " style={{borderTop:'1px solid white'}}>
       ...
       {isSidebarOpen &&  <aside className={`d-block d-md-none `} id='sidebar2' >
              <div onClick={()=>setIsSidebarOpen(false)}  className={`${isSidebarOpen ? 'd-block d-md-none ' : 'd-none'} cursor-pointer text-end px-4 `}>
                <i class="fa-solid fa-xmark"></i>
            </div>
           <NavLink to={'/'}>
